...
t1 = 5;
% do f(x)
[ f_loops, z_l1_loops, z_l2_loops, a_l2_loops, a_l3_loops ] = f(x, c,t1,t2,sig);
%[ f_vectorized, z_l1_vec, z_l2_vec, a_l2_vec, a_l3_vec ] = f_star_vec( x, c, t1, t2);
