function [] = get_best_trained_rbf_model_SGD(slurm_job_id, task_id)
% gets the best HBF1 model with k centers from the number of initilizations
%% Load paths
restoredefaultpath
slurm_job_id
task_id
run('load_paths_RBF.m');
%path;
help RBF
%% load configs
...
best_iteration_mdl = RBF(best_iteration_mdl_params);
