clear;
workspace_file_name = 'beta_start_0_end_1_num_betas_625_center_250'; % <- CHANGE
job_name = 'betas_21mar_j10'; % <- CHANGE
...
%fig = plot(betas, rbf_cv_errors, '-ro', betas, rbf_train_errors, '-b*')
%legend('RBF train errors','RBF test errors');
