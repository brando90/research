...
sgd_errors = 1
%% locations
cp_folder = 'cp_1mar_j3/'
cp_param_files_names = 'cp_1mar_j3_%d.m'
results_path = './results/r_1mar_j3/'
%% jobs
jobs = 20
start_centers = 1
end_centers = 180
...
data_normalized = 0
% NOT c_inits = (1 + 1) * rand(K, D_out) - 1
c_init_normalized = 0 % normc(rand(K,D_out))
%
gpu_on = 0
