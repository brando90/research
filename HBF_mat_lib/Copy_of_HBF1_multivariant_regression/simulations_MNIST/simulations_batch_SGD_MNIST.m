...
mdl_new_params = learn_HBF1_SGD( X_train, y_train, mdl_params, iterations,visualize, X_test,y_test);
time_passed = toc
%%
mdl_new = HBF1(mdl_new_params);
test_error_best_mdl = compute_Hf_sq_error(X_test,y_test, mdl_new, lambda)
train_error_best_mdl = compute_Hf_sq_error(X_train,y_train, mdl_new, lambda)
