...
for l=1:L
    for k=1:K
        e = zeros([K,L]);
        e(k,l) = eps;
        Hf_e1 = compute_Hf_sq_error(X,y,HBF1(HBF1_parameters(c + e,t,beta,lambda)), lambda );
        Hf_e2 = compute_Hf_sq_error(X,y,HBF1(HBF1_parameters(c - e,t,beta,lambda)), lambda );
