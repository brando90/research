...
%
function [imgs labels] = readMNIST()
%     imgFile, labelFile, readDigits, offset

    offset = 0;
    readDigits = 0;
    dataset_path = '../../data/mnist/';
    train_file_im = 'train-images-idx3-ubyte';
    train_file_lb = 'train-labels-idx1-ubyte';
    test_file_im = 't10k-images-idx3-ubyte';
    test_file_lb = 't10k-labels-idx1-ubyte';

    imgFile_aux = {[dataset_path train_file_im],[dataset_path test_file_im]};
    labelFile_aux = {[dataset_path train_file_lb],[dataset_path test_file_lb]};
    name_save = {'train','test'};
    for iii=1:length(imgFile_aux)
	readDigits = 0;
        imgFile = imgFile_aux{iii};
        labelFile = labelFile_aux{iii};
        % Read digits
        ...
        fclose(fid);
        name_save2 = ['mnist' name_save{iii} '.mat'];
        save(name_save2,'imgs','labels');
    end
