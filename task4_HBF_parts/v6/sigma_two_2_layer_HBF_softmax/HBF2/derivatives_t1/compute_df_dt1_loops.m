function [ dJ_dt1 ] = compute_df_dt1_loops(t1,x,z_l1,z_l2,a_l2,c,t2,sig)
...
for i=1:Np
    ...
    for j=1:Dd
        ...
        for k2=1:K2
            ...
            z_l2_k2 = z_l2(k2);
            new_delta = sig*ck2*(exp(-z_l2_k2))*2*(a_l2_ij - t2_k2_ij);
            alpha_ij = alpha_ij + new_delta;
        end
        alpha_ij = -sig * alpha_ij * exp(-z_l1_ij)*2*(xi_part - t_l1_ij);
        dJ_dt1(:,j,i) = alpha_ij;
    end
end