function [ mdl_new ] = learn_HBF1_batch_GD(Xtrain,ytrain, mdl_params, iterations,visualize, Xtest,Ytest)
...
for i=1:iterations
    %% get new parameters
    [c_new, dHf_dc] = update_c_batch(F,Kern,y, mdl_params);
    [t_new, dHf_dt] = update_t_batch(Kern,y, mdl_params);
    if visualize
    ...
    if visualize
        current_Hf = compute_Hf_sq_error(Xtrain,ytrain, mdl_new, lambda);
