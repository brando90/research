function [ mdl_new ] = learn_HBF1_SGD(X,y, mdl, mu_c,mu_t, lambda, iterations,visualize, Xtest,Ytest)
...
for i=1:iterations
    ...
    %% get new parameters
    [ f_x, z, a ] = mdl.f(x_i);
    [c_new, dJ_dc] = update_c_stochastic(f_x,y_i,a, mdl, mu_c, lambda );
    [t_new, dJ_dt] = update_t_stochastic(f_x,z,x_i,y_i, mdl, mu_t, lambda );
